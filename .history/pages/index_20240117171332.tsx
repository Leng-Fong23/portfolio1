        ...
        />
          ...
          <div className={styles.text}>
            ...
            <div className="flex items-center justify-center">
              <div className="bg-yellow-200 p-2 rounded-md flex items-center w-60">
                <a href="https://drive.google.com/file/d/1GFbDEpIVxzbKQ3M6xlCxya20VVmTU_74/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
                  <Image src="/button.png" alt="email" width="40" height="40" className=" justify-center item-center" />
                      </a>
                    </div>
                  </div>
                </div>
