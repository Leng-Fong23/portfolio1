...
const Home: React.FC = () => {
  ...
  return (
      ...
      <div className="inline-block bg-beb3e5 rounded-full p-4 mt-4 font-georgia text-22 font-bold">About Myself</div>
        ...
        <div className= "font-['Open_Sans'] flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-georgia text-1rem text-black">
