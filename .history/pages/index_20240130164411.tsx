...
<Menu as="div" className="relative inline-block text-left">
 ...
 <div>
    ...
    <div className="p-4 rounded-full text-center w-50%"> {/* Increase the width to 56 */}
  <Link href="./skill" target="_blank" rel="noopener noreferrer">
    <div className={styles.btngrad}>
      <div className=" mx-auto rounded-full p-2 font-georgia text-xs font-bold w-56 items-center">
