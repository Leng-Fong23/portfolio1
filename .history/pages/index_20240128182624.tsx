  ...
  <div className="flex flex-col sm:flex-row lg:flex-row">
    <div className="w-full sm:w-1/2 lg:w-1/3">
      <div className="customtableth ">
        <Image src="/profile.png" alt="lengfong" width={300} height={200} className="float-left p-2 m-10" />
      </div>
    </div>
    <div className="flex flex-col lg:flex-row lg:p-4 bg-[#F6F3E4] w-[50%] rounded-lg m-10 p-10">
      {/* Left side */}
      ...
      {/* Right side */}
      <div className="lg:w-1/3 mx-auto text-center align-center pl-10 pt-5">
