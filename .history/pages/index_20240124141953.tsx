...
const Home: React.FC = () => {
  ...
  return (
          ...
          <nav className=" w-full flex bg-[#f6f3e4] text-black p-4 justify-center z-50 left-0">
            <ul style={{ display: 'flex', listStyle: 'none', padding: 0 }}>
          ...
          <div className="min-h-screen flex justify-center items-center bg-cover bg-no-repeat bg-center" style={{ backgroundImage: 'url("/back.jpeg")' }}>

          <div className="relative">
            <Image src="/main3.gif" alt="lengfong" width="700" height="700" className={styles.img} />
          </div>
      ...
      <div className="inline-block bg-beb3e5 rounded-full p-4 mt-4 font-[Georgia]  text-[2.5rem] font-bold text-black text-left text-sm md:text-base lg:text-lg xl:text-xl">About Myself</div>
  ...
  <div id="achievment" className="box-border bg-cover bg-center bg-no-repeat w-full">
    <div className="overflow-hidden flex border-radius-40">
      <div className="font-['Georgia'] flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1rem text-black">
        <h1 className="font-['Georgia'] text-[2.5rem] font-bold text-black text-left text-sm md:text-base lg:text-lg xl:text-xl">Achievement</h1>
      </div>
    </div>
  </div>
...
<div>
  ...
  <div id="achievment" className="box-border bg-cover bg-center bg-no-repeat w-full">
    <div className="overflow-hidden flex border-radius-40">
      <div className="font-['Georgia'] flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1rem text-black">
        <h1 className="font-['Georgia'] text-[2.5rem] font-bold text-black text-left text-sm md:text-base lg:text-lg xl:text-xl">Skill</h1>
      </div>
    </div>
  </div>
  ...
  <div className="overflow-hidden border-radius-40">
    ...
    <div className="box-border m-10 text-center rounded-2xl pl-12 pr-10 ">
  <div className="bg-[#F6F3E4] mx-auto rounded-lg p-12 transition-transform transform hover:shadow-lg">
    <div className="flex items-center justify-center ">
      ...
      <div className="box-border m-10 text-center rounded-2xl pl-12 pr-10">
        <div className="bg-[#F6F3E4] rounded-lg p-12 transition-transform transform hover:shadow-lg">
          <div className="flex items-center justify-center ">
            <Card sx={{ maxWidth: 200 }}>
              <CardMedia
                component="img"
  ...
  <div id="achievement" className="box-border bg-cover bg-center bg-no-repeat w-full">
    <div className="overflow-hidden  border-radius-40">
      <div className="lg:flex">
      <div className="flex-1 box-border m-10 text-center rounded-2xl pl-12 pr-10">
        <div className="bg-[#F6F3E4] mx-auto rounded-lg p-12 transition-transform transform hover:shadow-lg">
        <div className="flex items-center justify-center ">
      <Card sx={{ maxWidth: 200 }}>
        <CardMedia
