        ...
        />
          ...
          <div className={styles.text}>
            ...
            <div className="flex items-center justify-center">
              <div className="bg-yellow-200 p-2 rounded-md flex items-center">
                <a href="file:///C:/Users/Thiew%20Leng%20Fong/Documents/Internship/Resume_Thiew%20Leng%20Fong.pdf" target="_blank" rel="noopener noreferrer">
                  <Image src="/button.png" alt="email" width="40" height="40" className={styles.icon} />
                  <h1 className={styles.h1}>Download Resume.pdf</h1>
                      </a>
                    </div>
                  </div>
                </div>
