...
and SJK (C) Yuk Cheng</Typography>
      ...
      <div className="p-8 bg-[#f6f3e4] relative rounded-2xl mt-20 mb-20 mx-auto w-full flex items-center font-[georgia]">
        <table className={styles.customtable}>
          <tbody>
            <tr>
            <td className="customtabletd text-center text-black text-[1.6rem]">
    ...
    <h1 className="font-['georgia'] text-[2.5rem] font-bold p-4">Work in Progress</h1>
        <>
      <Swiper
        effect={'coverflow'}
        grabCursor={true}
      ...
      >
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="pinkcake(1).jpeg" alt="Nature 1" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-1 h-1">
          <img className="block w-15 mx-auto" src="./study (2).jpeg" alt="Nature 2" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="https://swiperjs.com/demos/images/nature-3.jpg" alt="Nature 3" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="https://swiperjs.com/demos/images/nature-4.jpg" alt="Nature 4" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="https://swiperjs.com/demos/images/nature-5.jpg" alt="Nature 5" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="https://swiperjs.com/demos/images/nature-6.jpg" alt="Nature 6" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="https://swiperjs.com/demos/images/nature-7.jpg" alt="Nature 7" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="https://swiperjs.com/demos/images/nature-8.jpg" alt="Nature 8" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="https://swiperjs.com/demos/images/nature-8.jpg" alt="Nature 9" />
        </SwiperSlide>
      </Swiper>
    </>
