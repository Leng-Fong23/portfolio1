...
const Home: React.FC = () => {
  ...
  return (
        ...
        <div className ='mx-3'>
      <div className="w-[50%] sm:w-[80%] mx-auto px-[10px] absolute">
        <Swiper
          effect={'coverflow'}
          grabCursor={true}
          centeredSlides={true}
        ...
        >
          <SwiperSlide className="bg-center bg-cover w-[30%] sm:w-[50%] h-auto ">
            <img className="block mx-auto" src="./life (1).jpeg" alt="Nature 1" />
          </SwiperSlide>
          <SwiperSlide className="bg-center bg-cover w-[30%] sm:w-[50%] h-auto">
            <img className="block mx-auto" src="./life (3).jpeg" alt="Nature 2" />
          </SwiperSlide>
          <SwiperSlide className="bg-center bg-cover w-[30% ] sm:w-[50%] h-auto">
            <img className="block  mx-auto" src="./life (2).jpeg" alt="Nature 3" />
          </SwiperSlide>
          <SwiperSlide className="bg-center bg-cover w-[30% sm:w-[50%] h-auto">
            <img className="block  mx-auto" src="./life (4).jpeg" alt="Nature 4" />
          </SwiperSlide>
          <SwiperSlide className="bg-center bg-cover w-[30%] sm:w-[50%] h-auto">
            <img className="block  mx-auto" src="./life (5).jpeg" alt="Nature 5" />
          </SwiperSlide>
        </Swiper>
      </div>
