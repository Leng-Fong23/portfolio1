...
<div className="grid place-items-center">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
        <div className="w-100 h-100 bg-red-500 flex items-center justify-center text-white overflow-auto">
          Red dgehgdvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
        </div>
        <div className="w-100 h-100 bg-green-500 flex items-center justify-center text-white overflow-auto">
          Green vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvrnr3k3nbk3bk2bjvvvvvvvvvvvvvvv
        </div>
        <div className="w-100 h-100 bg-blue-500 flex items-center justify-center text-white overflow-auto">
