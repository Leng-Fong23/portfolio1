...
<div className="flex-1 text-center sm:text-left lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black items-center justify-center">
  <div className="inline-block rounded-full p-4 mt-4 text-center font-[Georgia] text-[2.5rem] font-bold">About Me</div>
