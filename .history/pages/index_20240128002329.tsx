...
const Home: React.FC = () => {
  ...
  return (
          ...
          <nav className=" w-full flex bg-transparent text-black p-4 justify-center z-50 left-0">
            <ul style={{ display: 'flex', listStyle: 'none', padding: 0 }}>
          ...
          <div className="relative">
            <Image src="/profile.png" alt="lengfong" width="700" height="700" className={styles.img} />
          </div>
