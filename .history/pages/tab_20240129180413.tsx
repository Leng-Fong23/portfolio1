...
const SingleTabComponent: React.FC = () => {
  ...
  return (
    ...
    <div className="flex space-x-4">
      <button
        className={`px-4 py-2 ${
          activeTab === 1 ? 'bg-grey text-black border-[#243c5a]' : 'bg-[#3A6AF2]'
        }`}
      ...
      <button
        className={`px-4 py-2 ${
          activeTab === 2 ? 'bg-grey text-black border-[#243c5a]' : 'bg-[#FFBE25]'
        }`}
      ...
      <button
        className={`px-4 py-2 ${
          activeTab === 3 ? 'bg-grey text-black border-[#243c5a]' : 'bg-[#3A6AF2]'
        }`}
