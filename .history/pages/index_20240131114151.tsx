...
const Home: React.FC = () => {
  ...
  return (
    <div className="  mx-auto">
      ...
      <div className="p-4 mt-4 font-[Georgia] text-[2.5rem] font-bold lg:pl-24 border-2 border-black">About Me</div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center">
          ...
          <div className="lg:w-2/3 lg:p-10">
              ...
              <div className="lg:w-1/3 mx-auto text-center align-center lg:pl-10 pt-2 flex flex-col items-center justify-center">
                ...
                <div className="relative w-full md:w-48 h-4 bg-gray-300 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-[#30D9A9]" <div className="flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black items-center">
                    <div className="inline-block bg-beb3e5 rounded-full p-4 mt-4 font-[Georgia]  text-[2.5rem] font-bold">About Myself</div>
                      <table className= "p-2 text-left font-yummy-dinner text-2xl bg-cover bg-center w-full rounded-lg" style={{ backgroundImage: "url('/back2.png')" }}>
                        <thead>
                          <tr>
                            <th className="w-1/3">
                              <div className="customtableth">
      ...
      <div>
        ...
        <div className="grid place-items-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div className={styles.flipcard}>
              <div className={styles.flipcardinner}>
                <div className={`${styles.flipcardfront} flex items-center justify-center `}>
          ...
          flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg">
                ...
                <div className={`${styles.flipcardback} flex items-center justify-center `}>
                  <div className="rounded-lg w-80 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-80 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#3A6AF2] 
            ...
            <div className={styles.flipcard}>
              <div className={styles.flipcardinner}>
               ...
               <div className={`${styles.flipcardback} flex items-center justify-center border-2 border-black`}>
                  <div className="rounded-lg w-80 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-80 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#3A6AF2] flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg relative">
                    <iframe
                      src="https://www.youtube.com/embed/gXgDaSb3jJA?si=VJNBdrZuv-Ikgzae"
                      title="YouTube video player"
