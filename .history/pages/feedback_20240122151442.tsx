      ...
      <main className="min-h-screen flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat mt-0">
        ...
        <div className={`${styles.text} p-4 lg:w-96 lg:h-96`}>
          ...
          <div className="flex justify-center pb-[4rem]">
            ...
            <h1 className=" flex justify-center text-[3rem]">Your Statisfaction</h1>
            <div className="flex justify-center size-[20rem]"> 
            <StyledRating
                sx={{
                    size: 'extraLarge', // Adjust the size to your desired value (e.g., extraLarge)
                    maxWidth: '150%',   // Adjust the maxWidth as needed
                }}
            ...
            />
                ...
                <TextField fullWidth label="fullWidth" id="fullWidth" />
                    ...
                    <h1 className=" flex justify-center">Thank yout for taking the time to provide feedback</h1>
        </div>
        </div>
        </div>
        </div>
