...
const SingleTabComponent: React.FC = () => {
  ...
  return (
    <div className="container mx-auto mt-8 p-4 rounded-lg font-[Georgia]">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
    ...
    <div className="rounded-tl-lg w-30 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-96 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#FFBE25] flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg">
    <div className="m-1">
        <Image src="/teamwork.png" alt="email" width="50" height="30" />
      </div>
