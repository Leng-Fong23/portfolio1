      ...
      <div className="inline-block p-4 rounded-full w-70"> {/* Increase the width to 56 */}
        <Link href="./skill" target="_blank" rel="noopener noreferrer">
          <div className={styles.btngrad}>
            ...
            <div className="flex-1 text-center pl-8 pr-8 pt-3 font-[georgia] text-base text-black">
              ...
              <div className="inline-block mr-4 bg-[#32D9A9] p-2 rounded-full">
          ...
          <div className="inline-block mr-4 bg-[#F2AB27] p-2 rounded-full">
          ...
          <div className="inline-block mr-4 bg-[#F27A96] p-2 rounded-full">
