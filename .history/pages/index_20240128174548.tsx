  ...
  <div className="flex flex-col sm:flex-row lg:flex-row">
    <div className="w-full sm:w-1/2 lg:w-1/3">
      <div className="customtableth">
        <Image src="/profile.png" alt="lengfong" width={150} height={200} className="float-right p-2 m-5" />
      </div>
    </div>
    <div className="flex flex-col lg:flex-row p-2 lg:p-4 bg-[#F6F3E4] rounded-lg">
      {/* Left side */}
