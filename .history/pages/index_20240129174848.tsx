...
<div className="flex justify-center items-center bg-transparent w-380 h-380 perspective-1000">
  <div className="w-full h-full text-center transition-transform transform-style-preserve-3d group hover:rotate-y-180">
   
    <div className="absolute w-full h-full front-face">
      <p className="text-black">Front Content</p>
    </div>
    
   
    <div className="absolute w-full h-full back-face rotate-y-180">
