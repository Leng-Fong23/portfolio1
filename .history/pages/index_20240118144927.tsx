        ...
        <div className={styles.ul}>
          ...
          <div className={styles.ul}>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;First runner up on Basketball Competition U17 <br />
              ...
              <div className="inline-block mr-2 bg-[#F6F3E4] p-4 rounded-full w-40">
            <Link href="./skill" target="_blank" rel="noopener noreferrer">
              <div className="inline-block bg-beb3e5 rounded-full p-4 mt-4 font-georgia text-40 font-bold">Know More</div>
              <FontAwesomeIcon icon={faArrowRight} className="fi fi-rr-arrow-right bg-white rounded-full p-2" />
            </Link>
          </div>
