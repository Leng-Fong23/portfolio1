    ...
    <h1 className="font-['georgia'] text-[2.5rem] font-bold p-4">Life Moment </h1>
      ...
      >
        <SwiperSlide className="w-full h-15">
          <img className=" w-full sm:w-5 mx-auto" src="./life (1).jpeg" alt="Nature 1" />
        </SwiperSlide>
        <SwiperSlide className="w-full h-15">
          <img className=" w-full mx-auto" src="./life (3).jpeg" alt="Nature 2" />
        </SwiperSlide>
        <SwiperSlide className="w-full h-15">
          <img className=" w-full mx-auto" src="./life (2).jpeg" alt="Nature 3" />
        </SwiperSlide>
        <SwiperSlide className="w-full h-15">
          <img className=" w-full mx-auto" src="./life (4).jpeg" alt="Nature 4" />
        </SwiperSlide>
        <SwiperSlide className="w-full h-15">
          <img className=" w-full mx-auto" src="./life (5).jpeg" alt="Nature 5" />
        </SwiperSlide>
      </Swiper>
    </div>
