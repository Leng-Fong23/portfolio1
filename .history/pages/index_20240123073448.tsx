...
const Home: React.FC = () => {
  ...
  return (
          ...
          <main className="min-h-screen flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat mt-0" style={{ background: 'url("/main-background.jpeg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
  <div className="relative pt-4" style={{ background: 'url("/download(2).jpeg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
    <Image src="/main3.gif" alt="lengfong" width="500" height="500" className={styles.img} />
  </div>
</main>
<div className="absolute top-[40rem] right-[28rem]" style={{ background: 'url("/other-background.jpg")', backgroundSize: 'cover', backgroundPosition: 'center', width: '100%', height: '100%' }}>
  <div className="animate-bounce">
    <Image src="/duck.png" alt="lengfong" width={300} height="300" />
  </div>
  <div className="static top-[-10rem] right-[28rem]">
