...
const FeedbackPage = () => {
  ...
  return (
    <div className={`${styles.text} min-h-screen flex justify-center items-center bg-cover bg-no-repeat bg-center bg-fixed`} style={{ backgroundImage: 'url("/Confetti.jpeg")' }}>
      <Head>
