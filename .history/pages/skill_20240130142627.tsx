...
const Home: React.FC = () => {
  ...
  return (
          ...
          <div className="min-h-screen bg-cover bg-no-repeat bg-center bg-fixed " style={{ backgroundImage: 'url("/Confetti.jpeg")', zIndex: 1}}>
    ...
    <div>
    <h1 className="font-[Georgia] text-[2.5rem] font-bold p-4">Travelling </h1>
      <Slides />
    </div>
...
<div className='bg-black w-100 border-2 border-red' style={{zIndex: 2}}>

cbjshkjahcdkbcjksdvhsdbsbjk
...
<Swiper
      ...
      >
        <SwiperSlide >
        <div className='bg-black w-[100%] p-[2px] '> 
