    ...
    <div className="overflow-hidden flex border-radius-40">
      ...
      <div className={styles.floatchild}>
        ...
        <div className="list-none p-0 items-center">
          ...
          <div className="inline-block bg-[#F6F3E4] p-4 rounded-full w-20"> {/* Increase the width to 56 */}
            <Link href="./skill" target="_blank" rel="noopener noreferrer">
              ...
              <FontAwesomeIcon icon={faArrowRight} className="fi fi-rr-arrow-right rounded-full p-0.5 text-sm w-5" />
              </div>
            </Link>
          </div>
        </div>
