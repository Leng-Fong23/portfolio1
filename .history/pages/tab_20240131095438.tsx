...
const SingleTabComponent: React.FC = () => {
  ...
  return (
    ...
    <div className="flex space-x-4 justify-center align-center border-2 border-red-500">
      <button
...
<div className="m-1">
  ...
  <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">2022-2023
</div>
...
<div className="m-1">
  ...
  <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">2021
</div>
  <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1rem]  ">
...
<div className="m-1">
  ...
  <div className="rounded-lg w-80 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-80 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#3A6AF2] flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg">
    <div className="m-1">
      ...
      <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">August 2021 to 
present
</div>
      <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1rem]  ">
...
Security)
    ...
    <div className="m-1">
      ...
      <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">September 2020 
to July 2021
</div>
      <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1rem]  ">
...
<Stack direction="row" alignItems="center" flexWrap="wrap" spacing={8}>
      <Stack spacing={2}>
        <CircularProgress size="lg" color="danger"  determinate value={70}>
          <Typography>{70}%</Typography>
        </CircularProgress>
      </Stack>
    </Stack>
  </div>
  <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">English
</div>
...
<Stack direction="row" alignItems="center" flexWrap="wrap" spacing={8}>
      <Stack spacing={2}>
        <CircularProgress size="lg" color="primary"  determinate value={70}>
          <Typography>{70}%</Typography>
        </CircularProgress>
      </Stack>
  ...
  <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">Malay
</div>
</div>
...
<Stack direction="row" alignItems="center" color="danger" flexWrap="wrap" spacing={8}>
  ...
  <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">Mandarin/Chinese</div>
</div>
