...
const Home: React.FC = () => {
  ...
  return (
          ...
          <nav className="fixed w-full flex bg-F6F3E4 text-black p-4 justify-center z-50">
            <ul style={{ display: 'flex', listStyle: 'none', padding: 0 }}>
      ...
      <main className="min-h-screen flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat mt-0">
            ...
            <Image src="/main.gif" alt="lengfong" width="500" height='500' className={styles.img}/>
            </div>
            <div className={styles.texta}>
      <h1 className={styles.h1}>About Myself</h1>
        <table className= "p-2 text-left font-yummy-dinner text-2xl bg-cover bg-center w-full" style={{ backgroundImage: "url('/background.png')" }}>
          <thead>
            <tr>
              <th className="w-1/3">
              ...
              <th className="w-1/2">
                <div className="customtableth text-white text-left">
      ...
      <div className={styles.content}>
        <table className={styles.customtable}>
          <tbody>
            ...
            <td className="customtabletd text-center text-black">
              ...
              <td className={styles.customtabletd}>
                <Image src="/pinkcake(1).jpeg" alt="MBTI" width="300" height='300' className={styles.imgb} /> <br />
              </td>
            </tr>
          </tbody>
          ...
          <tbody>
            <tr>
              <td className="customtabletd text-center text-black">
                <Image src="/pinkcake(2).jpeg" alt="MBTI" width="300" height='300' className={styles.imgb} /> <br />
              </td>
              <td className="customtabletd text-center text-black">
    ...
    <div className={styles.floatcontainer}>
      ...
      <div className={styles.iconContainer}>
              <Link href="./skill" target="_blank" rel="noopener noreferrer">
               <Image src="/next.png" alt="email" width="40" height="40" className={styles.icon} />
              </Link>
              </div>
