...
<div className="min-h-screen p-4">
  ...
  <div className="flex">
    ...
    <div className="w-3/4 p-8">
      ...
      <City id="London" <div className="flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black justify-center items-center mx-auto lg:text-center">
