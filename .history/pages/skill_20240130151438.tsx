  ...
  return (
    ...
    <h1 className="font-['georgia'] text-[2.5rem] font-bold p-4">Life Moment </h1>
      ...
      <Swiper
        ...
        className="mySwiper min-h-0 py-12 ml-10" // Add Tailwind CSS classes here
      >
        <SwiperSlide className="bg-center bg-cover w-[50%] h-15 ml-10">
          <img className="block w-[50%] sm:w-5 mx-auto" src="./life (1).jpeg" alt="Nature 1" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-[50%] h-15">
