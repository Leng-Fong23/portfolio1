    ...
    <div className={styles.floatcontainer}>
      ...
      <div className={styles.floatchild}>
        ...
        <div className={styles.ul}>
          ...
          <div className=" bg-[#F6F3E4] p-4 rounded-full w-70"> {/* Increase the width to 56 */}
            <Link href="./skill" target="_blank" rel="noopener noreferrer">
              <div className="inline-block bg-beb3e5 rounded-full p-4 font-georgia text-40 font-bold">Know More
