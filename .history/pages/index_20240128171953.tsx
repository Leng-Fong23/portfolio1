...
const Home: React.FC = () => {
  ...
  <div className="relative" style={{ top: '-1.5rem', textAlign: 'center' }}>
    <Image src="/profile.png" alt="lengfong" width="400" height="400" className="pt-20" />
    <h1 className="font-[Georgia] text-[2.5rem] font-bold p-4">Leng Fong</h1>
      ...
      <div className="inline-block p-4 rounded-full w-70"> {/* Increase the width to 56 */}
        <Link href="./feedback" target="_blank" rel="noopener noreferrer">
          <div className={styles.btngrad}>
            <div className="rounded-full p-4 font-[georgia] text-40 font-bold w-70">Hire Me
...
<div className="flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black items-center">
  ...
  <table className="p-2 text-left font-yummy-dinner text-2xl bg-cover bg-center w-full rounded-lg">
    <thead>
      <tr>
        <th className="w-1/4">
          <div className="customtableth">
            <Image src="/profile.png" alt="lengfong" width={300} height={300} className="float-right p-4 m-10" />
            <br />
          </div>
        </th>
       
        <th className="w-1/3 bg-[#F6F3E4] rounded-lg p-12" >
        ...
        <th className="w-2/3 bg-[#F6F3E4] rounded-lg p-12">
            <div className=" text-black text-left text-sm md:text-base lg:text-lg xl:text-xl ">
            <div className="flex flex-col gap-2">
            <div className=" text-black text-left text-sm md:text-base lg:text-lg xl:text-xl ">
             Python
          </div>
            <div className="relative w-70 h-4 bg-gray-300 rounded-full overflow-hidden">
              <div
                className="h-full bg-blue-500"
                style={{ width: '50%' }} // Set your desired percentage
              ></div>
