...
const Home: React.FC = () => {
  ...
  return (
    ...
    <div className={styles.floatcontainer}>
      ...
      <div className="inline-block mr-2 bg-[#F6F3E4] p-2 rounded-full">
              <Link href="./skill" target="_blank" rel="noopener noreferrer">
              <div className="inline-block bg-beb3e5 rounded-full p-4 mt-4 font-georgia text-22 font-bold">Know More</div>
