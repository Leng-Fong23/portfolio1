...
const Home: React.FC = () => {
  ...
  return (
          ...
          <div className="min-h-screen flex justify-center items-center bg-contain bg-cover bg-no-repeat w-full p-0 m-0" style={{ backgroundImage: 'url("/download (2).jpeg")', margin: 0, padding: 0 }}>
      ...
      <div id="achievment" className="box-border bg-cover bg-center bg-no-repeat w-full overflow-hidden flex border-radius-40">
    <div className="flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-georgia text-1rem text-black">
      <h1 className="font-maintain text-2.5rem font-bold">Achievement</h1>
        </div>
      </div>
    </div>

    <div className="box-border bg-cover bg-center bg-no-repeat w-full overflow-hidden flex border-radius-40">
    ...
    <div className={styles.floatchild}>
      <div className="bg-F6F3E4 rounded-lg p-12">
        <div className={styles.iconContainera}>
          <Image src="/sport.png" alt="Sport" width="75" height="75" className={styles.icon} />
        </div>
    ...
    <div id="hobby" className="box-border bg-cover bg-center bg-no-repeat w-full">
      ...
      <div className=" bg-[#f6f3e4] relative rounded-2xl mt-20 mb-20 mx-auto w-full flex items-center font-[georgia]">
