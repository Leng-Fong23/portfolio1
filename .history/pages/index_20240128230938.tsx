...
<div className="grid place-items-center">
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
    <div className="w-40 sm:w-36 md:w-40 lg:w-48 xl:w-48 h-50 sm:h-36 md:h-50 lg:h-48 xl:h-48 bg-red-500 flex items-center justify-center text-white p-2">
    ...
    <div className="w-40 sm:w-36 md:w-40 lg:w-48 xl:w-48 h-50 sm:h-36 md:h-50 lg:h-48 xl:h-48 bg-green-500 flex items-center justify-center text-white p-2">
    ...
    <div className="w-40 sm:w-36 md:w-40 lg:w-48 xl:w-48 h-50 sm:h-36 md:h-50 lg:h-48 xl:h-48 bg-blue-500 flex items-center justify-center text-white p-2">
