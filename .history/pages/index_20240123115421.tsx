...
const Home: React.FC = () => {
  ...
  return (
          ...
          <div className="min-h-screen flex justify-center items-center bg-cover bg-no-repeat w-full p-0 m-0" style={{ backgroundImage: 'url("/download (2).jpeg")', margin: 0, padding: 0 }}>
