...
const Home: React.FC = () => {
  ...
  return (
          ...
          <div className="min-h-screen flex justify-center items-center bg-cover bg-no-repeat bg-center" style={{ backgroundImage: 'url("/download (2).jpeg")' }}>

          <div className="relative">
            <Image src="/main.gif" alt="lengfong" width="700" height="700" className={styles.img} />
          </div>
    ...
    <div className="flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black items-center">
      ...
      <div id="achievement" className="box-border bg-cover bg-center bg-no-repeat w-full">
        <div className="overflow-hidden flex border-radius-40">
          <div className="sm:flex-1 sm:w-full lg:w-1/2">
            <div className="bg-[#F6F3E4] rounded-lg p-1">
              ...
              <h2 className="font-['georgia'] text-1.6rem font-bold md:text-1rem">Education</h2>
              <div className="list-none p-0 items-center">
                <div className="li">
                  <img src="/scholar.png" alt="Bullet Point" width="20" height="20" />
                  <p className="topica text-1.2rem pl-8 italic font-georgia block">
                    2021-2024
                    {'\n'}
                  </p>
                </div>
                <p className="text-base pl-2 block italic font-[georgia] md:text-1rem">
          ...
          <div className="sm:flex-1 sm:w-full lg:w-1/2">
            <div className="bg-[#F6F3E4] rounded-lg p-1 align-center item-center">
              <div className={styles.iconContainera}>
                <Image src="/sport.png" alt="Book" width="30" height="30" className={styles.icon} />
              </div>
              <h2 className="font-['georgia'] text-1.6rem font-bold md:text-1rem">Sport</h2>
              <div className="list-none p-0 items-center">
                <div className="li">
                  <img src="/gold medal.png" alt="Bullet Point" width="20" height="20" />
                  <p className="topica text-1.2rem pl-8 italic font-georgia block">
                    2019 <br />
                  </p>
                </div>
