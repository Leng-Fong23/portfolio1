...
const Home: React.FC = () => {
  ...
  return (
      ...
      <h1 className={styles.h1}>About Myself</h1>
        <table className= "p-2 text-left font-yummy-dinner text-2xl bg-cover bg-center w-full" style={{ backgroundImage: "url('/background2.png')" }}>
          <thead>
            <tr>
              <th className="w-1/3">
    ...
    <div className={styles.floatcontainer}>
      ...
      <div className={styles.floatchild}>
        ...
        <div className="inline-block bg-purple-500 rounded-full p-4 mt-4">
