...
const Home: React.FC = () => {
  ...
  return (
    ...
    <div id="hobby" className="bg-cover bg-center bg-no-repeat w-full">
  <div className="font-georgia flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 text-1rem text-black">
