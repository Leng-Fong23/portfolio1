  ...
  return (
      ...
      <main className="min-h-screen flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat mt-0">
            ...
            <div className="absolute bottom-0 left-0">
              ...
              <Image src="/girl2.png" alt="lengfong" width="1000" height="1000" />
              </div>
            </div>
    ...
    <div className="overflow-hidden flex border-radius-40">
      ...
      <div className={styles.floatchild}>
        ...
        <div className="inline-block bg-yellow transition-transform transform hover:scale-105 rounded-full p-4 mt-4">
      ...
      <div className={styles.floatchild}>
        <div className="bg-yellow rounded-lg p-12">
