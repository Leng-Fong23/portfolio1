  ...
  <div className="flex flex-col sm:flex-row lg:flex-row">
    <div className="w-full sm:w-1/2 lg:w-1/3">
      <div className="customtableth">
        <Image src="/profile.png" alt="lengfong" width={200} height={200} className="float-right p-2 m-5" />
      </div>
    </div>
    <div className="flex flex-col lg:flex-row p-10 lg:p-4 bg-[#F6F3E4] rounded-lg m-10">
      {/* Left side */}
