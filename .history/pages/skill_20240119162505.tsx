    ...
    <div className="overflow-hidden flex border-radius-40">
      ...
      <div className={styles.floatchild}>
        ...
        <div className="inline-block bg-[#beb3e5] transition-transform transform hover:scale-105 rounded-full p-4 mt-4 " >
          ...
          <button onClick={() => handleNavClick('#section1')}>August 2021</button>
          </div>
        </div>
        ...
        <Menu.Item>
          <a
            ...
            className={classNames(
              activeItem === 'accountSettings' ? 'bg-gray-100 text-gray-900' : 'text-gray-700',
              'block px-4 py-2 text-sm'
            )}
            onClick={() => {
              setActiveItem('accountSettings');
              // Add logic to handle click or other interactions
            }}
          >
            <img
              src="5.jpg" // Replace with the path to your image
