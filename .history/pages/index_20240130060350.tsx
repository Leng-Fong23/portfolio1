...
<div className="flex justify-center items-center">
  <div className="flex-1 text-center sm:text-justify lg:text-left -mt-2 sm:p-4 lg:p-2 lg:pl-2 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black justify-center items-center mx-auto">
