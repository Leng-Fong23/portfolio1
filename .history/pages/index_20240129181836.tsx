...
<Menu as="div" className="relative inline-block text-left">
 ...
 <div>
    ...
    <div className="inline-block p-4 rounded-full w-56 text-center mx-auto">
  <Link href="./skill" target="_blank" rel="noopener noreferrer">
    <div className={styles.btngrad}>
      <div className="rounded-full p-2 font-[georgia] text-[0.7rem] font-bold w-full">Know More</div>
    </div>
  </Link>
</div>
