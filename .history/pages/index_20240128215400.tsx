...
<div className="grid place-items-center">
      <div className="grid grid-cols-3 gap-4">
        <div className="w-40 h-40 bg-red-500 flex items-center justify-center text-white overflow-hidden">
          Red dgehgdvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
        </div>
        <div className="w-40 h-40 bg-green-500 flex items-center justify-center text-white overflow-hidden">
          Green vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvrnr3k3nbk3bk2bjvvvvvvvvvvvvvvv
        </div>
        <div className="w-40 h-40 bg-blue-500 flex items-center justify-center text-white overflow-hidden">
