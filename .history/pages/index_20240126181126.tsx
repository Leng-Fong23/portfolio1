...
const Home: React.FC = () => {
  ...
  return (
          ...
          <div className="relative">
            ...
            <div className="flex text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black items-center justify-center">
      <div className="flex inline-block bg-beb3e5 rounded-full p-4 mt-4 font-[Georgia]  text-[2.5rem] font-bold">About Myself</div>
        <table className= "flex p-2 text-left font-yummy-dinner text-2xl bg-cover bg-center w-[60%] rounded-lg" style={{ backgroundImage: "url('/background2.png')" }}>
          <thead>
            <tr>
              <th className="w-1/3">
    ...
    <div id="hobby" className="box-border bg-cover bg-center bg-no-repeat w-full">
          ...
          <div className="inline-block p-4 rounded-full w-70"> {/* Increase the width to 56 */}
            <Link href="./skill" target="_blank" rel="noopener noreferrer">
              ...
              <div className=" rounded-full p-4 font-[georgia] text-40 font-bold w-70">Know more
