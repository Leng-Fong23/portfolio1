...
const Home: React.FC = () => {
  ...
  return (
          ...
          <main className="min-h-screen flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat mt-0" style={{ background: 'url("/download(2).jpeg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
