...
const SingleTabComponent: React.FC = () => {
  ...
  return (
    ...
    <div className="flex space-x-4">
      <button
        className={`px-4 py-2 ${
          activeTab === 1 ? 'bg-[#3A6AF2] text-black border-[#243c5a]' : 'bg-[#3A6AF2]'
        }`}
      ...
      <button
        className={`px-4 py-2 ${
          activeTab === 2 ? 'bg-[#FFBE25] text-black border-[#243c5a]' : 'bg-[#FFBE25]'
        }`}
      ...
      <button
        className={`px-4 py-2 ${
          activeTab === 3 ? 'bg-[#F27999] text-black border-[#243c5a]' : 'bg-[#3A6AF2]'
        }`}
