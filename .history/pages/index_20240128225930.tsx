...
<div className="grid place-items-center">
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
    <div className="w-16 sm:w-20 md:w-24 lg:w-32 xl:w-32 h-16 sm:h-20 md:h-24 lg:h-32 xl:h-32 bg-red-500 flex items-center justify-center text-white">
      Red Red Red Red Red Red Red v Red Red RedRed Red vRedRed vRedRed
    </div>
    <div className="w-16 sm:w-20 md:w-24 lg:w-32 xl:w-32 h-16 sm:h-20 md:h-24 lg:h-32 xl:h-32 bg-green-500 flex items-center justify-center text-white">
      Green
    </div>
    <div className="w-16 sm:w-20 md:w-24 lg:w-32 xl:w-32 h-16 sm:h-20 md:h-24 lg:h-32 xl:h-32 bg-blue-500 flex items-center justify-center text-white">
      Blue
    </div>
  </div>
</div>
