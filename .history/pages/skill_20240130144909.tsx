        ...
        <div className="flex justify-center">
          <div className="inline-block p-4 rounded-full w-70"> {/* Increase the width to 56 */}
            <Link href="/" target="_blank" rel="noopener noreferrer">
              ...
              <div className=" rounded-full p-4 font-[georgia] text-40 font-bold w-70">Go Back
              <div className="flex items-center justify-center">
                <FontAwesomeIcon icon={faArrowRight} className="fi fi-rr-arrow-left rounded-full p-0.5 text-sm w-10" />
              </div>
              </div>
              </div>
        ...
        <div className="flex justify-center">
          <div className="inline-block p-4 rounded-full w-70"> {/* Increase the width to 56 */}
            <Link href="./feedback" target="_blank" rel="noopener noreferrer">
              <div className={styles.btngrad}>
              <div className=" rounded-full p-4 font-[georgia] text-40 font-bold w-70">FeedBack
              <div className="flex items-center justify-center">
                <FontAwesomeIcon icon={faArrowRight} className="fi fi-rr-arrow-left rounded-full p-0.5 text-sm w-10" />
              </div>
              </div>
...
<div>
    ...
    <div className="flex-1 text-center sm:text-justify lg:text-justify  p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black justify-center items-center mx-auto lg:text-center">
  <div id="achievment" className="box-border bg-cover bg-center bg-no-repeat w-full">
    <div className="overflow-hidden flex border-radius-40">
      <div className="font-['Georgia'] flex-1 text-center sm:text-justify  lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 text-1rem text-black">
        <h1 className=" text-[2.5rem] font-bold">Skill</h1>
      </div>
    </div>
  </div>
