...
const Home: React.FC = () => {
  ...
  return (
      ...
      <div className="relative pt-4">
        <Image src="/Hi-I-M-2--unscreen.gif" alt="lengfong" width={500} height={500} className="img" />
      </div>
      <div className="texta">
        <h1 className="text-3xl font-bold">About Myself</h1>
        <table className={`${styles.customtable} bg-cover bg-center w-full`} style={{ backgroundImage: "url('/HI.png')" }}>
          <thead>
            <tr>
              <th className="w-1/2">
                <div className="customtableth">
                  <Image src="/5.png" alt="lengfong" width={1000} height={1000} />
                  <br />
                </div>
              </th>
              <th className="w-1/2">
