...
const Home: React.FC = () => {
  ...
  return (
      ...
      <main className="min-h-screen flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat mt-0">
            ...
            <div className="relative pt-4" style={{ background: 'url("/your-background-image.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
  <Image src="/main3.gif" alt="lengfong" width="500" height="500" className={styles.img} />
            ...
            <div className="absolute top-[40rem] right-[28rem]">
              ...
              <div className="static top-[-10 rem] right-[28rem]">
          ...
          <thead>
            <tr>
              ...
              <div className="customtableth text-black text-left text-sm md:text-base lg:text-lg xl:text-xl">
                Hi, <a className = "underline decoration-sky-500/30">I am Leng Fong.</a> I was born in Kelantan in the year of 2002. I am currently in my final year at Sunway University, majoring in Information Technology (Computer Networking and Security).
              </div>
              </th>
            </tr>
          </thead>
