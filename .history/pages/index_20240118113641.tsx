...
const Home: React.FC = () => {
  ...
  return (
          ...
          <nav className="navbar bg-F6F3E4 p-10 fixed w-full">
            <ul className="flex justify-center items-center">
              {navItems.map((item, index) => (
                <li key={index} className="nav-item mx-4">
                  <a
      ...
      <h1 className={styles.h1}>About Myself</h1>
        <table className={`${styles.customtable} bg-cover bg-center w-full`} style={{ backgroundImage: "url('/background.png')" }}>
          <thead>
            <tr>
              <th className="w-1/3">
