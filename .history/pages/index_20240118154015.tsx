...
const Home: React.FC = () => {
  ...
  return (
    ...
    <div className="bg-[#F6F3E4] p-10 border border-solid border-[#eaeaea] rounded-md text-left">

<div id="contact" className="mb-10">
  <div className="flex items-center">
    <div className="flex-shrink-0">
      <h1 className="text-2.5xl font-bold">Achievement</h1>
    </div>
  </div>
</div>
...
<div id="contact" className="mb-10">
  <div className="flex items-center">
    <div className="flex-shrink-0">
      ...
      <h2 className="text-1.6rem font-bold">Education</h2>
      <ul className="list-none">
        <li className="flex items-center">
          <img src="/scholar.png" alt="Bullet Point" className="w-7 h-7" />
          <p className="text-1rem">2021-2024</p>
        </li>
        <li>
          <p className="italic">Recipient of the Jeffery Cheah continuing scholarship</p>
        </li>
...
<div id="contact">
  <div className="flex items-center">
    <div className="flex-shrink-0">
      <div className="inline-block bg-[#beb3e5] rounded-full p-4 mt-4">
        <Image src="/sport.png" alt="Sport" width="75" height="75" />
      </div>
      <h2 className="text-1.6rem font-bold">Sport</h2>
      <ul className="list-none">
        <li className="flex items-center">
          <img src="/gold medal.png" alt="Bullet Point" className="w-7 h-7" />
          <p className="text-1rem">2019</p>
        </li>
        <li>
          <p className="italic">Champion on District Competition</p>
        </li>
        {/* Add more list items as needed */}
      </ul>
    </div>
