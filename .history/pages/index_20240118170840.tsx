...
const Home: React.FC = () => {
  ...
  <div id="contact" className="box-border bg-cover bg-center bg-no-repeat w-full max-w-screen-xl mx-auto">
    <div className="overflow-hidden flex flex-col sm:flex-row border-radius-40">
      <div className="font-['Georgia'] flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1rem text-black">
      ...
      <div className={styles.floatchild}>
        <div className="bg-[#F6F3E4] rounded-lg p-12">
          <div className="inline-block bg-[#beb3e5] transition-transform transform hover:scale-105 rounded-full p-4 mt-4">
            <Image src="/book.png" alt="Book" width="75" height="75" className="w-full sm:w-auto" />
          </div>
          ...
          <div className="list-none p-0 items-center">
            <div className={styles.li}>
              ...
              <p className="topica text-1.2rem pl-8 italic font-georgia block">2021-2024{'\n'}</p>
            </div>
          </div>

          {/* Additional education details go here */}
        </div>
      </div>
      ...
      <div className={styles.floatchild}>
        <div className="bg-[#F6F3E4] rounded-lg p-12">
          <div className={styles.iconContainera}>
            <Image src="/sport.png" alt="Book" width="75" height="75" className="w-full sm:w-auto" />
          </div>
          <h2 className="font-['georgia'] text-1.6rem font-bold">Sport</h2>
          <div className="list-none p-0 items-center">
            <div className={styles.li}>
              <img src="/gold medal.png" alt="Bullet Point" width="30" height="30" />
              <p className="topica text-1.2rem pl-8 italic font-georgia block">2019<br /></p>
            </div>
          </div>

          {/* Additional sport details go here */}
        </div>
      </div>
    </div>
  </div>
          ...
          <div className="inline-block bg-[#F6F3E4] p-4 rounded-full w-70"> {/* Increase the width to 56 */}
            <Link href="./skill" target="_blank" rel="noopener noreferrer">
              ...
              <FontAwesomeIcon icon={faArrowRight} className="fi fi-rr-arrow-right rounded-full p-0.5 text-sm sm:text-lg lg:text-xl" />
              </div>
            </Link>
          </div>
        </div>
            ...
            <div className="flex-1 text-center text-justify pl-8 pr-8 pt-3 font-[georgia] text-base text-black p-8 md:p-10 bg-[#F6F3E4] relative rounded-2xl my-20 mx-auto w-full">
