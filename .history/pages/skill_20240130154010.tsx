...
>
  <SwiperSlide className="bg-center bg-cover w-[10%] sm:w-[20%] h-auto ">
    <img className="block mx-auto" src="./life (1).jpeg" alt="Nature 1" width="100" height="100"/>
  </SwiperSlide>
  <SwiperSlide className="bg-center bg-cover w-[10%] sm:w-[20%] h-auto">
    <img className="block mx-auto" src="./life (3).jpeg" alt="Nature 2" width="100" height="100" />
  </SwiperSlide>
  <SwiperSlide className="bg-center bg-cover w-[10%] sm:w-[20%] h-auto">
    <img className="block  mx-auto" src="./life (2).jpeg" alt="Nature 3" width="100" height="100" />
  </SwiperSlide>
  <SwiperSlide className="bg-center bg-cover w-[10%] sm:w-[20%] h-auto">
    <img className="block  mx-auto" src="./life (4).jpeg" alt="Nature 4" width="100" height="100" />
  </SwiperSlide>
  <SwiperSlide className="bg-center bg-cover w-[10%] sm:w-[20%] h-auto">
    <img className="block  mx-auto" src="./life (5).jpeg" alt="Nature 5" width="100" height="100"/>
  </SwiperSlide>
</Swiper>
      ...
      <tr>
        ...
        <Link href="./feedback" target="_blank" rel="noopener noreferrer">
          <div className={styles.btngrad}>
            <div className="rounded-full p-2 font-[georgia] text-[0.7rem] font-bold w-70">Go Back
            </div>
          </div>
        </Link>
      </div>
