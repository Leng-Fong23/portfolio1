...
and SJK (C) Yuk Cheng</Typography>
      ...
      <div id="achievment" className="box-border bg-cover bg-center bg-no-repeat w-full">
        ...
        <div className="font-['Georgia'] flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1rem text-black">
              <h1 className="font-['Georgia'] text-[2.5rem] font-bold">Education</h1>
        </div>
      </div>
    </div>
...
<div className={`${styles.text} p-4 lg:w-96 lg:h-96`}>
  ...
  <div className="p-10 md:p-10 bg-[#F6F3E4] relative rounded-2xl mt-5 mb-5 mx-auto w-full flex items-center">
  <div className="flex items-center justify-center p-2 rounded-md">
    ...
    <div className="flex justify-center">
          ...
          <a href="https://drive.google.com/file/d/1GFbDEpIVxzbKQ3M6xlCxya20VVmTU_74/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
              <div className=" bg-beb3e5 rounded-full p-10 font-[georgia] text-60 font-bold w-80">Resume.pdf
              <div className="flex items-center justify-center">
                  <Image src="/pdf.png" alt="email" width="40" height="40" className="fi fi-rr-arrow-right rounded-full p-0.5 text-sm w-10" />
                </div>
              </div>
            </a>
          </div>
