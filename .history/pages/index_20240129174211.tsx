...
<div className="flex items-center justify-center mx-auto p-2">
  <div className="grid place-items-center">
    <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4 justify-center">
      
      <div className={styles.flipcard}>
        <div className={styles.flipcardinner}>
          <div className={styles.flipcardfront}>
            <div className="rounded-lg w-96 sm:w-50 md:w-56 lg:w-64 xl:w-64 h-96 sm:h- md:h-80 lg:h-64 xl:h-64 bg-[#3A6AF2] flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105">
          ...
          <div className={styles.flipcardback}>
            <div className="rounded-lg w-96 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-96 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#3A6AF2] flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105">
              <div className="m-1">
                <Image src="/code.png" alt="email" width="50" height="30" />
              </div>
              <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">Object Oriented Programming</div>
  ...
  <div id="achievment" className="box-border bg-cover bg-center bg-no-repeat w-full">
    <div className="overflow-hidden flex border-radius-40">
      <div className="font-['Georgia'] flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1rem text-black">
        <h1 className="font-['Georgia'] text-[2.5rem] font-bold">Extra-Cocuriculum</h1>
      </div>
    </div>
  </div>
...
<div>
 ...
 <div>
      <h1 className="text-2xl font-bold text-center mt-8">Simple Tabs Example</h1>
      <SingleTabComponent />
    </div>
    ...
    <div id="hobby" className="box-border bg-cover bg-center bg-no-repeat w-full">
          ...
          <div className="inline-block bg-[#F6F3E4] p-4 rounded-full w-70"> {/* Increase the width to 56 */}
            <Link href="./FlipCard" target="_blank" rel="noopener noreferrer">
