...
interface SinglePageVideoPlayerProps {
  videoId: string;
  coverImage: string;
}
...
const Home: React.FC = () => {
  ...
  return (
    <div className="  mx-auto">
      ...
      <div className=" rounded-full p-4 mt-4 font-[Georgia]  text-[2.5rem] font-bold">About Me</div>
      <div className="px-6 lg:mx-20">
            ...
            <tr>
              <th className="w-1/4">
                <div className="customtableth">
                  <Image src="/lf (2).png" alt="lengfong" width={600} height={500} className="float-left " />
                  <br />
                </div>
              </th>
              ...
              <th className="w-1/3">
                ...
                {/* Skill Section */}
                <div className=" rounded-full font-[Georgia] text-[1.5rem] font-bold pb-3">
                  Skill
                </div>
  ...
  <div className="px-6 lg:mx-40">
    <div className="p-4 text-left font-yummy-dinner text-2xl bg-cover bg-center w-full rounded-lg" style={{ backgroundImage: "url('/back2.png')" }}>
      <div className="lg:flex">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="lg:w-1/3 mx-auto text-center align-center lg:pl-2  flex flex-col items-center justify-center py-2">
                ...
                <div className="text-black font-[Georgia] font-bold p-2 text-left text-sm md:text-base lg:text-lg xl:tex-[0.9rem]">
                  Oses
                </div>
                ...
                {/* Traffic Analysis Section */}
                <div className="text-black font-[Georgia] font-bold p-2 text-left text-sm md:text-base lg:text-lg xl:text-[0.9rem]">
                  TrafficAnalysis
                </div>
                <div className="relative w-full md:w-48 lg:w-56 h-4 bg-gray-300 rounded-full overflow-hidden">
                  <div className="h-full bg-[#FFBE25]" style={{ width: '60%' }}></div>
      ...
      <div>
        <div className="p-4 mt-4 font-[Georgia] text-[2.5rem] font-bold lg:pl-24 ">Project</div>
        <div className="grid place-items-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">

            <div className={styles.flipcard}>
              <div className={styles.flipcardinner}>
                <div className={`${styles.flipcardfront} items-center justify-center `}>
                  <div className="rounded-lg w-80 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-80 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#3A6AF2] 
          flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg">
                    <div className="m-1">
                      <Image src="/teamwork.png" alt="email" width="50" height="30"/>
                    </div>
                    <div className="inline-block rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">Object Oriented Programming
                    </div>
                    <div className="inline-block rounded-full  text-center font-[Georgia] text-[1rem]  ">
                ...
                <div className={`${styles.flipcardback}  items-center justify-center `}>
                  <div className="rounded-lg w-80 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-80 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#3A6AF2] 
                  flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg relative">
                    <iframe
            ...
            <div className={styles.flipcard}>
              <div className={styles.flipcardinner}>
                 <div className={`${styles.flipcardfront} items-center justify-center `}>
                  <div className="rounded-lg w-80 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-80 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#F2AB27] 
                  flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg">
                    <div className="m-1">
                      <Image src="/teamwork.png" alt="email" width="50" height="30" />
                    </div>
                    <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">Networking
                    </div>
                    <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1rem]  ">
                      Virtual Web Server,DNS,DHCP and WAP
                    </div>
                  </div>
                </div>
               <div className={`${styles.flipcardback}  items-center justify-center `}>
                  <div className="rounded-lg w-80 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-80 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#3A6AF2] flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg relative">
                    <iframe
                      src="https://www.youtube.com/embed/a4wam3TTjv0?si=tRMRb16iSa46hlhi"
                      title="YouTube video player"
            ...
            <div className={styles.flipcard}>
              <div className={styles.flipcardinner}>
                 <div className={`${styles.flipcardfront}  items-center justify-center `}>
                  <div className="rounded-lg w-80 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-80 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#FC7596] flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg">
                    <div className="m-1">
                      <Image src="/teamwork.png" alt="email" width="50" height="30" />
                    </div>
                    <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">Web Fundamental
                    </div>
                    <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1rem]  ">
                      Create a websites
                    </div>
      ...
      <div className="flex justify-center items-center">
        <div className="flex-1 text-center sm:text-justify lg:text-left -mt-2 lg:pl-20 lg:pr-8  font-[georgia] text-1.5rem text-black justify-center items-center mx-auto">
          <div id="achievment" className="box-border bg-cover bg-center bg-no-repeat w-full">
            <div className="overflow-hidden flex border-radius-40">
              <div className="font-['Georgia'] flex-1 text-center sm:text-justify lg:text-left lg:pl-8 lg:pr-8 ] text-1rem text-black">
      ...
      <div id="contact" className="box-border bg-cover bg-center bg-no-repeat w-full text-left">
        <div className="flex-1 text-left pl-8 pr-8 py-3  text-base text-black">
          <h1 className="font-[georgia] text-[2.5rem] font-bold pb-8">Find Me On</h1>
          <div className="inline-block mr-4 bg-[#3D6AF2] p-2 rounded-full">
            <a href="lengfong0323@gmail.com" target="_blank" rel="noopener noreferrer">
              <Image src="/contact (3).png" alt="email" width="40" height="40" className={styles.icon} />
            </a>
          </div>
          <div className="inline-block mr-4 bg-[#3D6AF2] p-2 rounded-full">
            <a href="https://www.facebook.com/thiew.lengfong.5?mibextid=LQQJ4d" target="_blank" rel="noopener noreferrer">
              <Image src="/contact (2).png" alt="email" width="40" height="40" className={styles.icon} />
            </a>
          </div>
          <div className="inline-block mr-4 bg-[#3D6AF2] p-2 rounded-full">
            <a href="https://www.instagram.com/leng_fong?igsh=Zmt4cWExYmJ2a3J2&utm_source=qr" target="_blank" rel="noopener noreferrer">
              <Image src="/contact (1).png" alt="email" width="40" height="40" className={styles.icon} />
            </a>
          </div>
          <div className="inline-block mr-4 bg-[#3D6AF2] p-2 rounded-full">
            <a href="tel:+1234567890">
              <Image src="/contact (4).png" alt="phone" width="40" height="40" className={styles.icon} />
            </a>
          </div>
        </div>
      </div>
