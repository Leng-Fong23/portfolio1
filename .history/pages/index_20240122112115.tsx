...
const Home: React.FC = () => {
  ...
  return (
      ...
      <div className="inline-block bg-beb3e5 rounded-full p-4 mt-4 font-[Maintain]  text-[2.5rem] font-bold">About Myself</div>
        <table className= "p-2 text-left font-yummy-dinner text-2xl bg-cover bg-center w-full rounded-lg shadow-xl" style={{ backgroundImage: "url('/background2.png') shadow-xl" }}>
          <thead>
            <tr>
              <th className="w-1/3">
      ...
      <div id="achievment" className="box-border bg-cover bg-center bg-no-repeat w-full">
        ...
        <div className="font-['Georgia'] flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1rem text-black shadow-xl">
