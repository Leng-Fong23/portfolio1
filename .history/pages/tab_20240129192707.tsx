...
const SingleTabComponent: React.FC = () => {
  ...
  return (
    <div className="container mx-auto mt-8 p-4 font-[Georgia] border-2 border-red-600">
    <div className="flex space-x-4">
      <button
        className={`px-4 py-2 rounded-t-lg border-2 border-red-600  ${
          activeTab === 1 ? 'bg-[#3A6AF2] text-white border-[#243c5a] rounded-r-lg' : 'bg-[#3A6AF2] rounded-r-lg'
        }`}
      ...
      <button
        className={`px-4 py-2   ${
          activeTab === 2 ? 'bg-[#FFBE25] text-white border-[#243c5a] rounded-r-lg' : 'bg-[#FFBE25] rounded-r-lg'
        }`}
      ...
      <button
        className={`px-4 py-2 rounded-r-lg ${
          activeTab === 3 ? 'bg-[#F27999] text-white border-[#243c5a] rounded-r-lg' : 'bg-[#F27999] rounded-r-lg'
        }`}
    ...
    <div className="mt-4">
      {activeTab === 1 && (
        <div>
            <div className="inline-block p-4 mt-4 font-[Georgia] text-[2.5rem] font-bold pl-10">Achivement</div>
            <div className="grid place-items-center">
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
    
    <div className="rounded-t-lg w-30 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-96 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#3A6AF2] flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg">
      <div className="m-1">
