...
const Home: React.FC = () => {
  ...
  return (
    ...
    <div className={styles.floatchild}>
      <div className="bg-[#F6F3E4] rounded-lg p-4 relative">
        <div
          className={`inline-block bg-[#beb3e5] transition-transform transform hover:scale-105 rounded-full p-4 mt-4 ${styles.hoverContainer}`}
          onMouseEnter={handleHover}
          onMouseLeave={handleHover}
        >
          <h2 className="font-['georgia'] text-1.6rem font-bold space-y-4">
