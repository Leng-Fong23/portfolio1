...
<div className="flex-1 text-center sm:text-left lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black items-center">
  <div className="rounded-full p-4 mt-4 text-center font-[Georgia] text-[2.5rem] font-bold">About Me</div>
  <div className="flex flex-col sm:flex-row lg:flex-col items-center justify-center ">
    ...
    <div className="flex flex-col lg:flex-row lg:p-4 bg-[#EEEDEB] rounded-lg m-10 p-10">
      ...
      <div className="inline-block p-2 rounded-full w-70"> {/* Increase the width to 56 */}
      <a href="https://drive.google.com/file/d/1GFbDEpIVxzbKQ3M6xlCxya20VVmTU_74/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
          <div className={styles.btngrad}>
      ...
      <div className="lg:w-1/3 mx-auto text-center align-center lg:pl-10 pt-2 border-2 border-green-500 flex flex-col items-center justify-center mx-auto">
      <div className="inline-block bg-beb3e5 rounded-full  font-[Georgia] text-[1.5rem] font-bold lg:mr-[20rem] border-2 border-red-500">Skill</div>
...
<div className="grid place-items-center">
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
    ...
    <div className="rounded-lg w-30 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-96 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#3A6AF2] flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg">
      ...
      <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">Object Oriented Programming</div>
      <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1rem]  ">
        MasterMind Board Game
      </div>
    </div>
    
    <div className="rounded-lg w-30 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-96 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#FFBE25] flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg">
    <div className="m-1">
        <Image src="/teamwork.png" alt="email" width="50" height="30" />
      </div>
      <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">Networking</div>
      <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1rem]  ">
    ...
    <div className="m-1">
      ...
      <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">Web Development</div>
      <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1rem]  ">
    ...
    <div className="flex-1 text-center sm:text-justify  lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black justify-center items-center mx-auto">
  <div id="achievment" className="box-border bg-cover bg-center bg-no-repeat w-full">
    <div className="overflow-hidden flex border-radius-40">
      <div className="font-['Georgia'] flex-1 text-center sm:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 ] text-1rem text-black">
  ...
  <div id="achievement" className="box-border bg-cover bg-center bg-no-repeat w-full">
    <div className="overflow-hidden  border-radius-40">
      ...
      <div className={`${styles.floatchild} lg:w-1/2`}>
        <div className="bg-[EEEDEB] rounded-lg p-12">
        <Timeline
      sx={{
