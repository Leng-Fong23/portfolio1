  ...
  <div className="flex flex-col sm:flex-row lg:flex-row">
    <div className="w-full sm:w-1/3 lg:w-1/4">
      <div className="customtableth">
        <Image src="/profile.png" alt="lengfong" width={300} height={300} className="float-right p-10 m-10" />
        <br />
      </div>
    </div>
    <div className="flex flex-col lg:flex-row p-2 lg:p-12 bg-[#F6F3E4] rounded-lg">
  {/* Left side */}
