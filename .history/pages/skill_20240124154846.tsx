        ...
        <table className={styles.customtable}>
          <tbody>
            ...
            <td className="customtabletd text-center text-black text-[1.6rem]">
                <p className=" text-[1.5rem] font-bold">Indulging in the sweetness of homemade joy. 🍰💖 </p>
              </td>
          ...
          <tbody>
            <tr>
              ...
              <p className=" text-[1.5rem] font-bold">Baking love into every fluffy layer of this chiffon masterpiece. 💕 </p>
              </td>
            </tr>
          </tbody>
        </table>
