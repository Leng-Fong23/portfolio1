  ...
  return (
      ...
      <main className="min-h-screen flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat mt-0">
          ...
          <div className="text">
            ...
            <div className="p-10 bg-white border rounded-lg mt-5">
              <ul className="list-disc pl-5">
                <li>Familiar with different operating systems (OSes) like Windows, MacOS, and Linux.</li>
                <li>Strong in analyzing network traffic using Wireshark.</li>
                <li>Strong on using different tools for detection.</li>
                <li>Strong in programming (JAVA & Python), create and design websites.</li>
                <li>Familiar with database analysis, SQL, Oracle Apex.</li>
                <li>Skilled in HTML, CSS, and JavaScript.</li>
                <li>Ability to communicate with different groups of people, lead a team, follow instructions, and get a job done on time.</li>
              </ul>
            </div>
          </div>
        </div>
