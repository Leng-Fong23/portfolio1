  ...
  return (
    <div className="  mx-auto">
      ...
      <div className="inline-block bg-beb3e5 rounded-full p-4 mt-4 font-[Georgia]  text-[2.5rem] font-bold">About Myself</div>
        <table className= "p-4 text-left font-yummy-dinner text-2xl bg-cover bg-center w-full rounded-lg" style={{ backgroundImage: "url('/background2.png')" }}>
          <thead>
            <tr>
              <th className="w-1/3">
                <div className="customtableth">
                  <Image src="/lf (2).png" alt="lengfong" width={1000} height={1000} className="float-left p-6" />
                  <br />
                </div>
              </th>
              <th className="w-2/3">
          ...
          <div className="lg:w-2/3 lg:p-10">
               <div className="flex flex-col lg:flex-row lg:p-4 rounded-lg ">
              {/* Left side */}
              <div className="lg:w-2/3 lg:p-10">
