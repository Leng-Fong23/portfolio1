  ...
  return (
      ...
      <main className="min-h-screen flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat mt-0">
            ...
            <div className="absolute top-[40rem] right-[28rem]">
              ...
              <div className="static top-[1 rem] right-[28rem]">
      ...
      <div className="inline-block bg-beb3e5 rounded-full p-4 mt-4 font-[Maintain]  text-[2.5rem] font-bold absolute">About Myself</div>
        <table className= "p-2 text-left font-yummy-dinner text-2xl bg-cover bg-center w-full rounded-lg relative" style={{ backgroundImage: "url('/background2.png')" }}>
          <thead>
            <tr>
              <th className="w-1/3">
