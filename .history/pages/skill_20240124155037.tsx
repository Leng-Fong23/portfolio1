        ...
        <table className={styles.customtable}>
          <tbody>
            ...
            <td className="customtabletd text-center text-black">
                <p className=" text-[2rem] ">Indulging in the sweetness of homemade joy. 🍰💖 </p>
              </td>
              <td className="customtabletd text-center text-black">
          ...
          <tbody>
            <tr>
              ...
              <p className=" text-[2rem]">Baking love into every fluffy layer of this chiffon masterpiece. 💕 </p>
              </td>
            </tr>
          </tbody>
        </table>
