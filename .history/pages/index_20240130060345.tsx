...
<div className="flex justify-center items-center">
  <div className="flex-1 text-center sm:text-justify lg:text-left -mt-2 sm:p-4 lg:p-2 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black justify-center items-center mx-auto">
  ...
  <div id="achievement" className="box-border bg-cover bg-center bg-no-repeat w-full">
    <div className="overflow-hidden  border-radius-40">
      ...
      <div className={`${styles.floatchild} lg:w-1/2`}>
        <div className="bg-[EEEDEB] rounded-lg px-20 md:px-12">
        <Timeline
      sx={{
