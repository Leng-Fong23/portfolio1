    ...
    <div className={styles.container}>
      ...
      <main className="min-h-screen  justify-center items-center bg-cover bg-center bg-no-repeat mt-0">
        ...
        <div className={`${styles.text} p-4 lg:w-96 lg:h-96`}>
          ...
          <div className="flex-1 justify-center pb-[4rem]">
            <Autocomplete
            sx={{
                width: 500,
                maxWidth: '100%',
            ...
            <div className='text-[14px] font-bold flex-1 justify-center'>
            <h1>Your Statisfaction</h1>
            </div>
            <div className="flex-1 justify-center size-[20rem] pb-10rem]"> 
            <StyledRating
            ...
            <div className="bg-[#beb3e5] flex-1 justify-center transition-transform transform hover:scale-105 rounded-full p-4 mt-4">
