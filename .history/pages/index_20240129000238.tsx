...
<div className="grid place-items-center">
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
    ...
    <div className="rounded-lg w-80 sm:w-36 md:w-40 lg:w-48 xl:w-48 h-80 sm:h-36 md:h-70 lg:h-48 xl:h-48 bg-[#3A6AF2] flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg">
      <div className="mb-4">
    ...
    <div className="rounded-lg w-40 sm:w-36 md:w-40 lg:w-48 xl:w-48 h-70 sm:h-36 md:h-70 lg:h-48 xl:h-48 bg-[#FFBE25] flex items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg">
    ...
    <div className="rounded-lg w-40 sm:w-36 md:w-40 lg:w-48 xl:w-48 h-70 sm:h-36 md:h-70 lg:h-48 xl:h-48 bg-[#F27999] flex items-center justify-center text-white p-2 transition-transform transform-gpu hover:scale-105 shadow-lg">
