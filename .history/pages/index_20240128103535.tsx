...
const Home: React.FC = () => {
  ...
  return (
          ...
          <div className="min-h-screen flex justify-center items-center bg-cover bg-no-repeat bg-center align-[4px]" style={{ backgroundImage: 'url("/Confetti.jpeg")' }}>
  <div className="relative" style={{ top: '-10rem', textAlign: 'center' }}>
    ...
    <div className="flex justify-center">
      <div className="inline-block p-4 rounded-full w-70">
        <Link href="./feedback" target="_blank" rel="noopener noreferrer">
          <div className={styles.btngrad}>
            <div className="rounded-full p-4 font-[georgia] text-40 font-bold w-70">
              Hire Me
    ...
    {/* Move the Resume.pdf section lower by adding margin-top */}
    <div className="mt-8"> {/* You can adjust the margin-top value */}
