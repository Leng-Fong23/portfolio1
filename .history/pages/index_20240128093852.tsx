...
const Home: React.FC = () => {
  ...
  return (
          ...
          <div className="min-h-screen flex justify-center items-center bg-cover p-8 bg-no-repeat bg-center align-[4px]" style={{ backgroundImage: 'url("/Confetti.jpeg")' }}>
  <div className="relative" style={{ top: '-10rem', textAlign: 'center' }}>
    ...
    <div className="flex justify-center">
          <div className="inline-block bg-[#F6F3E4] p-8 rounded-full w-70"> {/* Increase the width to 56 */}
            <Link href="./skill" target="_blank" rel="noopener noreferrer">
              <div className=" bg-beb3e5 rounded-full p-4 font-[georgia] text-40 font-bold w-70">Hire Me
