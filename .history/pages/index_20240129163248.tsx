...
<div className="grid place-items-center">
  ...
  <div className={styles.flipcard}>
        <div className={styles.flipcardinner}>
          ...
          <div className="rounded-lg w-96 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-96 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#3A6AF2] flex flex-col items-center justify-center text-white p-2 ">
      <div className="m-1">
