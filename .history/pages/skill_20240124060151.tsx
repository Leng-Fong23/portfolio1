    ...
    <h1 className="font-['georgia'] text-[2.5rem] font-bold p-4">Nature</h1>
      ...
      >
        <SwiperSlide className="bg-center bg-cover w-30 h-30">
          <img className="block w-30 mx-auto" src="pinkcake(1).jpeg" alt="Nature 1" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-25 h-25">
          <img className="block w-25 mx-auto" src="https://swiperjs.com/demos/images/nature-2.jpg" alt="Nature 2" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-25 h-25">
          <img className="block w-25 mx-auto" src="https://swiperjs.com/demos/images/nature-3.jpg" alt="Nature 3" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-25 h-25">
          <img className="block w-25 mx-auto" src="https://swiperjs.com/demos/images/nature-4.jpg" alt="Nature 4" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-25 h-25">
          <img className="block w-25 mx-auto" src="https://swiperjs.com/demos/images/nature-5.jpg" alt="Nature 5" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-25 h-25">
          <img className="block w-25 mx-auto" src="https://swiperjs.com/demos/images/nature-6.jpg" alt="Nature 6" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-25 h-25">
          <img className="block w-25 mx-auto" src="https://swiperjs.com/demos/images/nature-7.jpg" alt="Nature 7" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-25 h-25">
          <img className="block w-25 mx-auto" src="https://swiperjs.com/demos/images/nature-8.jpg" alt="Nature 8" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-25 h-25">
          <img className="block w-25 mx-auto" src="https://swiperjs.com/demos/images/nature-8.jpg" alt="Nature 9" />
        </SwiperSlide>
      </Swiper>
    </>
