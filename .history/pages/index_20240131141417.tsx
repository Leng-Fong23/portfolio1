...
const Home: React.FC = () => {
  ...
  return (
    <div className="  mx-auto">
      ...
      <div className="flex-1 text-center sm:text-justify  lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black items-center">
      ...
      <table className= "p-4 text-left font-yummy-dinner text-2xl bg-cover bg-center w-full rounded-lg " style={{ backgroundImage: "url('/back2.png')" }}>
          <thead>
            <tr>
              ...
              <th className="w-1/3">
                            <div className="lg:w-1/3 mx-auto align-center lg:pl-2  flex flex-col items-center justify-center">
                {/* Skill Section */}
                <div className="inline-block bg-beb3e5 rounded-full font-[Georgia] text-[1.5rem] font-bold pb-3">
                  Skill
                </div>
                <div className="text-black py-2 text-left text-sm md:text-base lg:text-lg xl:text-[15px]">
                  Oses
                </div>
                ...
                <div className="text-black py-2 text-sm md:text-base lg:text-lg xl:text-[15px]">
                  Traffic Analysis
                </div>
                <div className="relative w-full md:w-48 lg:w-56 h-4 bg-gray-300 rounded-full overflow-hidden">
