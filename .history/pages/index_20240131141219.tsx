          ...
          <thead>
            <tr>
              ...
              <th className="w-1/3">
                ...
                <div className="text-black py-2 text-left text-sm md:text-base lg:text-lg xl:text-[0.9rem]">
                  Oses
                </div>
                ...
                <div className="text-black py-2 text-sm md:text-base lg:text-lg xl:text-[0.9rem]">
                  Traffic Analysis
                </div>
                <div className="relative w-full md:w-48 lg:w-56 h-4 bg-gray-300 rounded-full overflow-hidden">
