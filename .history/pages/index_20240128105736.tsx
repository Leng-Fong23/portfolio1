...
const Home: React.FC = () => {
  ...
  <div className="relative" style={{ top: '-2rem', textAlign: 'center' }}>
    ...
    <a href="https://drive.google.com/file/d/1GFbDEpIVxzbKQ3M6xlCxya20VVmTU_74/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
      <div className="bg-beb3e5 rounded-full font-[georgia] text-60 font-bold w-90">
        Resume.pdf
        <div className="flex items-center justify-center">
          <Image src="/mouse-cursor.png" alt="email" width="80" height="8" className="fi fi-rr-arrow-right rounded-full p-0.5 text-sm w-10" />
        </div>
      </div>
    </a>
