...
const Home: React.FC = () => {
  ...
  return (
          ...
          <div className="min-h-screen flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat mt-0" style={{ backgroundImage: 'url("/download (2).jpeg")' }}>
            <div className="relative pt-4">
              <Image src="/download (2).jpeg" alt="lengfong" width="500" height="500" className={styles.img} />
            </div>
