...
<div className="grid place-items-center">
      <div className="grid grid-cols-3 gap-4">
        <div className="w-16 h-16 bg-red-500 flex items-center justify-center text-white">
          Red dgehgdvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
        </div>
        <div className="w-16 h-16 bg-green-500 flex items-center justify-center text-white">
