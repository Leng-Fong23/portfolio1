...
and SJK (C) Yuk Cheng</Typography>
    ...
    <h1 className="font-['georgia'] text-[2.5rem] font-bold p-4">Life Sharing </h1>
        <>
      <Swiper
        effect={'coverflow'}
        grabCursor={true}
      ...
      >
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="./life (2).jpeg" alt="Nature 1" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-1 h-1">
          <img className="block w-15 mx-auto" src="./life (3).jpeg" alt="Nature 2" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="./life (1).jpeg" alt="Nature 3" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
