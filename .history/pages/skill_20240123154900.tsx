...
<div className={`${styles.text} p-4 lg:w-96 lg:h-96`}>
  ...
  <div className="flex items-center justify-center p-2 rounded-md">
    ...
    <div className="flex justify-center">
          <div className="inline-block bg-[#F6F3E4] p-4 rounded-full w-200"> {/* Increase the width to 56 */}
          <a href="https://drive.google.com/file/d/1GFbDEpIVxzbKQ3M6xlCxya20VVmTU_74/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
              <div className=" bg-beb3e5 rounded-full p-10 font-[georgia] text-60 font-bold w-90">Resume.pdf
              <div className="flex items-center justify-center">
                  <Image src="/pdf.png" alt="email" width="80" height="80" className="fi fi-rr-arrow-right rounded-full p-0.5 text-sm w-20" />
                </div>
              </div>
            </a>
          </div>
