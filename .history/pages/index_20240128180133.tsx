  ...
  <div className="flex flex-col sm:flex-row lg:flex-row">
    <div className="w-full sm:w-1/2 lg:w-1/3">
      <div className="customtableth ">
        <Image src="/profile.png" alt="lengfong" width={300} height={200} className="float-center p-2 m-10" />
      </div>
    </div>
    <div className="flex flex-col lg:flex-row lg:p-4 bg-[#F6F3E4] rounded-lg m-4 p-10">
      {/* Left side */}
      <div className="lg:w-3/2 lg:p-10">
      ...
      {/* Right side */}
      <div className="lg:w-1/3 align-center">
