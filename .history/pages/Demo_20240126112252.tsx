...
<div className='min-h-screen'>
  ...
  <div className="flex">
    {/* Buttons */}
    <div className="block text-black py-5 px-4  border-none outline-none text-left cursor-pointer transition duration-300 text-base">
    <div className="flex ">
      <button className="tablinks bg-gray-300 rounded-full" onClick={(e) => openCity(e, 'London')} id="defaultOpen">
        London
      </button>
      </div>
      <div className="flex">
