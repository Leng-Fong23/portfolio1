    ...
    <div className={styles.container}>
      ...
      <main className="min-h-screen  justify-center items-center bg-cover bg-center bg-no-repeat mt-0">
        ...
        <div className={`${styles.text} p-4 lg:w-96 lg:h-96`}>
          ...
          <div className=" justify-center pb-[4rem]">
            <Autocomplete
            sx={{
                width: 500,
                maxWidth: '100%',
            ...
            <div className='text-[14px] font-bold  justify-center'>
            <h1>Your Statisfaction</h1>
            </div>
            <div className=" justify-center size-[20rem] pb-10rem]"> 
            <StyledRating
            ...
            <div className="bg-[#beb3e5]  justify-center transition-transform transform hover:scale-105 rounded-full p-4 mt-4">
          ...
          <div className="inline-block bg-[#F6F3E4] p-4 rounded-full "> {/* Increase the width to 56 */}
            <Link href="/" target="_blank" rel="noopener noreferrer">
              <div className=" bg-beb3e5 rounded-full p-4 font-[georgia] text-40 font-bold ">Go Back
