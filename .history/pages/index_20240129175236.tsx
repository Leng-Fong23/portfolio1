...
<div className="grid place-items-center">
  ...
  <div
      className={`rounded-lg w-96 sm:w-48 md:w-56 lg:w-64 xl:w-64 h-96 sm:h-48 md:h-80 lg:h-64 xl:h-64 bg-[#3A6AF2] flex flex-col items-center justify-center text-white p-2 transition-transform transform-gpu ${
        isFlipped ? 'rotateY-180' : '' // Apply the rotation when flipped
      } hover:rotateY-180 shadow-lg`}
    ...
    >
      ...
      <div className="inline-block bg-beb3e5 rounded-full text-center font-[Georgia] text-[1.2rem] font-bold p-2">
