...
const SingleTabComponent: React.FC = () => {
  ...
  return (
    ...
    <div className="flex space-x-4">
      <button
        className={`px-4 py-2 ${
          activeTab === 1 ? 'bg-blue-500 text-black border-2 border-[#243c5a]' : 'bg-transparent'
        }`}
      ...
      <button
        className={`px-4 py-2 ${
          activeTab === 2 ? 'bg-blue-500 text-black border-2 border-[#243c5a]' : 'bg-transparent'
        }`}
      ...
      <button
        className={`px-4 py-2 ${
          activeTab === 3 ? 'bg-blue-500 text-black border-2 border-[#243c5a]' : 'bg-transparent'
        }`}
