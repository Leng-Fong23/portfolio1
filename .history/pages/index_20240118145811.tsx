    ...
    <div className={styles.floatcontainer}>
      ...
      <div className={styles.floatchild}>
        ...
        <div className="flex justify-center">
          <div className="inline-block bg-[#F6F3E4] p-4 rounded-full w-64">
            <Link href="./skill" target="_blank" rel="noopener noreferrer">
              ...
              <FontAwesomeIcon icon={faArrowRight} className="fi fi-rr-arrow-right bg-white rounded-full p-1 w-4 h-4" /> {/* Adjust the width and height */}
            </Link>
          </div>
        </div>
