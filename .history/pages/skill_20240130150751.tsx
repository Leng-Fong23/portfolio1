  ...
  return (
    ...
    <h1 className="font-['georgia'] text-[2.5rem] font-bold p-4">Life Moment </h1>
      ...
      >
        ...
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="w-15 mx-auto" src="./life (3).jpeg" alt="Nature 2" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="w-15 mx-auto" src="./life (2).jpeg" alt="Nature 3" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="w-15 mx-auto" src="./life (4).jpeg" alt="Nature 4" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="w-15 mx-auto" src="./life (5).jpeg" alt="Nature 5" />
        </SwiperSlide>
      </Swiper>
    </>
