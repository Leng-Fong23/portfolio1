...
<div className="inline-block bg-beb3e5 rounded-full p-4 mt-4 font-[Georgia] text-[2.5rem] font-bold ml-16">Service</div>
<div className="grid place-items-center ">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4 pl-20 pr-20 ml-20 mr-20">
        <div className="w-50  bg-red-500 flex items-center justify-center text-white overflow-hidden whitespace-normal rounded-lg p-5">
        ...
        <div className="w-50  bg-green-500 flex items-center justify-center text-white overflow-hidden whitespace-normal rounded-lg p-5">
          Green vvvvvvvvvv vvvvvvvvvvvvvvvvvv vvvvvvv vvvvvvvvvvvvrnr3k3n bk3bk2bjvvvv vvvvvvvvvvv
          Bluevvv vvvvvvvvvvv vvvvvvvvvvvv  vvvvv vvvvvvvvvvvv vvvvvvvvvv vvvvvvvvvvv vvvvvvvv
        </div>
        <div className="w-50  bg-blue-500 flex items-center justify-center text-white overflow-hidden whitespace-normal rounded-lg p-5">
          Bluevvv vvvvvvvvvvv vvvvvvvvvvvv  vvvvv vvvvvvvvvvvv vvvvvvvvvv vvvvvvvvvvv vvvvvvvv
          Bluevvv vvvvvvvvvvv vvvvvvvvvvvv  vvvvv vvvvvvvvvvvv vvvvvvvvvv vvvvvvvvvvv vvvvvvvv
        </div>
      </div>
