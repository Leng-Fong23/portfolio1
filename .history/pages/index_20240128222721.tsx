...
<div className="flex-1 text-center sm:text-left lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black items-center">
  ...
  <div className="flex flex-col sm:flex-row lg:flex-row">
    ...
    <div className="flex flex-col lg:flex-row lg:p-4 bg-[#EEEDEB] w-[60%] rounded-lg m-10 p-10">
      ...
      <a href="https://drive.google.com/file/d/1GFbDEpIVxzbKQ3M6xlCxya20VVmTU_74/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
          <div className={styles.btngrad}>
            <div className="rounded-full p-2 font-[georgia] text-20 font-bold w-70">Resume.pdf
              <div className="flex items-center justify-center">
              <Image src="/pdf.png" alt="email" width="30" height="5" />
              </div>
            </div>
          </div>
        </a>
...
<div className="grid place-items-center rounded-full">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4 p-4">
        <div className="w-40 h-30 bg-red-500 flex items-center justify-center text-white overflow-hidden whitespace-normal rounded-lg p-2">
        ...
        <div className="w-400 h-30 bg-green-500 flex items-center justify-center text-white overflow-hidden whitespace-normal rounded-lg p-2">
          Green vvvvvvvvvv vvvvvvvvvvvvvvvvvv vvvvvvv vvvvvvvvvvvvrnr3k3n bk3bk2bjvvvv vvvvvvvvvvv
          Bluevvv vvvvvvvvvvv vvvvvvvvvvvv  vvvvv vvvvvvvvvvvv vvvvvvvvvv vvvvvvvvvvv vvvvvvvv
        </div>
        <div className="w-400 h-30 bg-blue-500 flex items-center justify-center text-white overflow-hidden whitespace-normal rounded-lg p-2">
          Bluevvv vvvvvvvvvvv vvvvvvvvvvvv  vvvvv vvvvvvvvvvvv vvvvvvvvvv vvvvvvvvvvv vvvvvvvv
          Bluevvv vvvvvvvvvvv vvvvvvvvvvvv  vvvvv vvvvvvvvvvvv vvvvvvvvvv vvvvvvvvvvv vvvvvvvv
        </div>
      </div>
