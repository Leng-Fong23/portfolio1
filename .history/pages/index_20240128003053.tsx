...
const Home: React.FC = () => {
  ...
  return (
          ...
          <div className="min-h-screen flex justify-center items-center bg-cover bg-no-repeat bg-center align-top" style={{ backgroundImage: 'url("/Confetti.jpeg")' }}>

          <div className="relative">"
            <Image src="/profile.png" alt="lengfong" width="400" height="400" className="align-top"/>
          </div>
