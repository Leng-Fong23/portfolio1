    ...
    <div className="flex space-x-4">
      <button
        className={`px-4 py-2 rounded-t-lg border-2 border-red-600  ${
          activeTab === 1 ? 'bg-[#3A6AF2] text-white border-[#243c5a] rounded-r-lg' : 'bg-[#3A6AF2]'
        }`}
      ...
      <button
        className={`px-4 py-2   ${
          activeTab === 2 ? 'bg-[#FFBE25] text-white border-[#243c5a] rounded-r-lg' : 'bg-[#FFBE25]'
        }`}
      ...
      <button
        className={`px-4 py-2 rounded-r-lg ${
          activeTab === 3 ? 'bg-[#F27999] text-white border-[#243c5a] rounded-r-lg' : 'bg-[#F27999]'
        }`}
