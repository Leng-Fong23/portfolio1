...
<div>
    ...
    <div className="flex items-center justify-center ">
      <Card sx={{ maxWidth: 200 }}>
        ...
        <CardContent>
          ...
          <div className="text-[16px] font-['Georgia']">
      ...
      <div className="box-border m-10 text-center rounded-2xl pl-2 pr-2">
        <div className="bg-[#F6F3E4] rounded-lg p-2 transition-transform transform hover:shadow-lg">
          <div className="flex items-center justify-center ">
            <Card sx={{ maxWidth: 200 }}>
              <CardMedia
                component="img"
  ...
  <div id="achievement" className="box-border bg-cover bg-center bg-no-repeat w-full">
    <div className="overflow-hidden  border-radius-40">
      <div className="lg:flex">
      <div className="flex-none box-border m-10 text-center rounded-2xl pl-2 pr-2">
        <div className="bg-[#F6F3E4] mx-auto rounded-lg p-12 transition-transform transform hover:shadow-lg">
        <div className="flex items-center justify-center ">
      <Card sx={{ maxWidth: 200 }}>
        <CardMedia
      ...
      <div className="flex-1 box-border m-10 text-center rounded-2xl pl-2 pr-2">
        <div className="bg-[#F6F3E4] rounded-lg p-12 transition-transform transform hover:shadow-lg">
        <div className="flex items-center justify-center ">
        <Card sx={{ maxWidth: 200 }}>
          <CardMedia
