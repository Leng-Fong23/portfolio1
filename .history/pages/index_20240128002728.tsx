...
const Home: React.FC = () => {
  ...
  return (
          ...
          <div className="min-h-screen justify-center items-center bg-cover bg-no-repeat bg-center p-10 inline-block align-middle" style={{ backgroundImage: 'url("/Confetti.jpeg")' }}>

          <div className="relative">
            <Image src="/profile.png" alt="lengfong" width="400" height="400" className="align-middle" />
          </div>
