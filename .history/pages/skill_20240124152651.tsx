    ...
    <h1 className="font-['georgia'] text-[2.5rem] font-bold p-4">Work in Progress</h1>
      ...
      >
        ...
        <SwiperSlide className="bg-center bg-cover w-1 h-1">
          <img className="block w-15 mx-auto" src="./study (1).jpeg" alt="Nature 2" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="./study (3).jpeg" alt="Nature 3" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="./study (4).jpeg" alt="Nature 4" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="./study (5).jpeg" alt="Nature 5" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
