...
<Stack direction="row" alignItems="center" flexWrap="wrap" spacing={8}>
      <Stack spacing={2}>
        <CircularProgress size="lg" color="warning"  determinate value={70}>
          <Typography>{70}%</Typography>
        </CircularProgress>
      </Stack>
    </Stack>
  </div>
  <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">ENgslish
</div>
...
<Stack direction="row" alignItems="center" flexWrap="wrap" spacing={8}>
  ...
  <div className="inline-block bg-beb3e5 rounded-full  text-center font-[Georgia] text-[1.2rem] font-bold p-2">Malay/Bahasa Malaysia
</div>
</div>
