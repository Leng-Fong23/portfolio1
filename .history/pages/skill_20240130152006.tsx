...
const Home: React.FC = () => {
  ...
  return (
      ...
      <Swiper
        ...
        className="min-h-0 py-12 ml-10" // Add Tailwind CSS classes here
      >
        <SwiperSlide className="bg-center bg-cover w-[30%] sm:w-[50%] h-auto ">
          <img className="block w-[50%] sm:w-5 mx-auto" src="./life (1).jpeg" alt="Nature 1" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-[30% w-[50%] h-auto">
          <img className="block w-[50%] mx-auto" src="./life (3).jpeg" alt="Nature 2" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-[30% w-[50%] h-auto">
          <img className="block w-[50%] mx-auto" src="./life (2).jpeg" alt="Nature 3" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-[30% w-[50%] h-auto">
          <img className="block w-[50%] mx-auto" src="./life (4).jpeg" alt="Nature 4" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-[30% w-[50%] h-auto">
          <img className="block w-[50%] mx-auto" src="./life (5).jpeg" alt="Nature 5" />
        </SwiperSlide>
      </Swiper>
    </div>
