...
<div className="text-center font-Arial mx-auto max-w-800 px-20">
      ...
      <p className="mt-2">4.1 average based on 254 reviews.</p>
      <hr className="border-t-3 border-gray-300 mt-4" />

      <div className="row">
        {/* RatingBar for 5 stars */}
        <div className="side">
          <div>5 star</div>
        </div>
