...
const Home: React.FC = () => {
  ...
  return (
      ...
      <h1 className={styles.h1}>About Myself</h1>
        <table className= "p-2 text-left text-4xl bg-cover bg-center w-full font-yummy-dinner" style={{ backgroundImage: "url('/background.png')" }}>
          <thead>
            <tr>
              <th className="w-1/3">
              ...
              <th className="w-1/2">
                <div className="customtableth text-white text-left font-fontyummydinner">
