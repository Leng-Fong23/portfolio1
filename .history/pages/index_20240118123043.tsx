      ...
      <div className={styles.content}>
        <table className={styles.customtable}>
          <tbody>
            ...
            <td className="customtabletd text-center text-black">
              ...
              <td className={styles.customtabletd}>
                <Image src="/cake1.jpeg" alt="MBTI" width="300" height='300' className={styles.imgb} /> <br />
              </td>
            </tr>
          </tbody>
          ...
          <tbody>
            <tr>
              <td className="customtabletd text-center text-black">
                <Image src="/cake2.jpeg" alt="MBTI" width="300" height='300' className={styles.imgb} /> <br />
              </td>
              <td className="customtabletd text-center text-black">
