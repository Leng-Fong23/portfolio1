  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
    ...
    >
      <style jsx>{`
        @keyframes dash {
          0% {
            stroke-dashoffset: 283; /* Circumference of a circle with radius 45% */
            stroke: transparent; /* Initial color */
          }
          100% {
            stroke-dashoffset: 0;
            stroke: #f27999; /* Final color */
          }
        }
      `}</style>
      <CircularProgress
        ...
        value={66.67}
        sx={{
          animation: "dash 1.5s ease-in-out forwards", // Use the defined animation
          stroke: "transparent", // Set initial color to transparent
        }}
      >
        2 / 3
      </CircularProgress>
