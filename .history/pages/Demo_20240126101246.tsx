...
and SJK (C) Yuk Cheng</Typography>
        ...
        <div className= " font-['Georgia'] flex-1 text-center sm:text-justify lg:text-justify lg:text-left p-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-black">
      <h1 className=" text-[2.5rem] font-bold">Baking as one of my hobby</h1>
        ...
        <table className={styles.customtable}>
          <tbody>
            ...
            <td className="customtabletd text-center text-black">
                <h1 className="text-2xl ">Indulging in the sweetness of homemade joy. 🍰💖 </h1>
              </td>
              <td className="customtabletd text-center text-black">
          ...
          <tbody>
            <tr>
              ...
              <td className="customtabletd text-center text-black text-[40px]">
              <h1 className=" text-2xl">Baking love into every fluffy layer of this chiffon masterpiece. 💕 </h1>
              </td>
            </tr>
          </tbody>
        </table>
    ...
    <h1 className="font-['georgia'] text-[2.5rem] font-bold p-4">Life Moment </h1>
        <>
      <Swiper
        effect={'coverflow'}
        grabCursor={true}
      ...
      >
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="./life (1).jpeg" alt="Nature 1" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-1 h-1">
          <img className="block w-15 mx-auto" src="./life (3).jpeg" alt="Nature 2" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="./life (2).jpeg" alt="Nature 3" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="./life (4).jpeg" alt="Nature 4" />
        </SwiperSlide>
        <SwiperSlide className="bg-center bg-cover w-15 h-15">
          <img className="block w-15 mx-auto" src="./life (5).jpeg" alt="Nature 5" />
        </SwiperSlide>
      </Swiper>
    </>
...
<div className={`${styles.text} p-4 lg:w-96 lg:h-96`}>
    ...
    <div className="inline-block bg-[#F6F3E4] p-4 rounded-full w-56">
      <Link href="./feedback" target="_blank" rel="noopener noreferrer">
        <div className="bg-beb3e5 rounded-full p-4 font-[georgia] text-40 font-bold w-56">Feedback
    ...
    <div className="mt-4 inline-block bg-[#F6F3E4] p-4 rounded-full w-56">
      <Link href="./Demo" target="_blank" rel="noopener noreferrer">
        <div className="bg-beb3e5 rounded-full p-4 font-[georgia] text-40 font-bold w-56">Go Back
          <div className="flex items-center justify-center">
            <FontAwesomeIcon icon={faArrowRight} className="fi fi-rr-arrow-right rounded-full p-0.5 text-sm w-10" />
          </div>
        </div>
  ...
  <div className="flex flex-col items-center lg:items-start">
    <div className="inline-block bg-[#F6F3E4] p-4 rounded-full w-56">
      <a href="https://drive.google.com/file/d/1GFbDEpIVxzbKQ3M6xlCxya20VVmTU_74/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
        <div className="bg-beb3e5 rounded-full p-10 font-[georgia] text-60 font-bold w-56">Resume.pdf
          <div className="flex items-center justify-center">
