...
and SJK (C) Yuk Cheng</Typography>
    ...
    <div className="overflow-hidden flex border-radius-40">
      ...
      >
        ...
        <div className="min-h-screen flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat mx-auto mt-0 w-[80%] h-[80%]">
        <>
        <Swiper
        effect={'cards'}
        grabCursor={true}
        modules={[EffectCards]}
        className="w-[80%] h-[80%] min-h-0 flex justify-center items-center ml-20">
        <SwiperSlide>
        <img src="/pinkcake(1).jpeg" alt="Slide 1" />
        </SwiperSlide>
        <SwiperSlide>
        <img src="/pinkcake(1).jpeg" alt="Slide 1" />
        </SwiperSlide>
