...
const Home: React.FC = () => {
  ...
  <div className="relative" style={{ top: '-1.5rem', textAlign: 'center' }}>
    <Image src="/profile.png" alt="lengfong" width="300" height="300" className="pt-20" />
  ...
  <div className="flex flex-col sm:flex-row lg:flex-row">
    ...
    <div className="flex flex-col lg:flex-row lg:p-4 bg-[#EEEDEB] w-[60%] rounded-lg m-10 p-10">
      ...
      <div className="lg:w-2/3 lg:p-10">
        ...
        <div>
      <div className="inline-block p-2 rounded-full w-70 left-align"> {/* Increase the width to 56 */}
      <a href="https://drive.google.com/file/d/1GFbDEpIVxzbKQ3M6xlCxya20VVmTU_74/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
          <div className={styles.btngrad}>
...
<div className="inline-block bg-beb3e5 rounded-full p-4 mt-4 font-[Georgia] text-[2.5rem] font-bold ml-10">Project</div>
    <div className="grid place-items-center">
      <div className="mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4 pl-4 pr-4 sm:pl-8 sm:pr-8 md:pl-10 md:pr-10 lg:pl-12 lg:pr-12 xl:pl-12 xl:pr-12">
          <div className="w-full sm:w-1/2 bg-red-500 flex items-center justify-center text-white overflow-hidden whitespace-normal rounded-lg p-4 sm:p-5 md:p-6 lg:p-8">
            Red dgehgd vvvv vvvvv vvvv vvvvv vvvvvvvv vvvvvvvvvv vvvvvvvvvvvv vvvvvvvvvvv vvvvvv vvvvvvv
            Bluevvv vvvvvvvvvvv vvvvvvvvvvvv  vvvvv vvvvvvvvvvvv vvvvvvvvvv vvvvvvvvvvv vvvvvvvv
          </div>
          <div className="w-full sm:w-1/2 bg-green-500 flex items-center justify-center text-white overflow-hidden whitespace-normal rounded-lg p-4 sm:p-5 md:p-6 lg:p-8">
            Green vvvvvvvvvv vvvvvvvvvvvvvvvvvv vvvvvvv vvvvvvvvvvvvrnr3k3n bk3bk2bjvvvv vvvvvvvvvvv
            Bluevvv vvvvvvvvvvv vvvvvvvvvvvv  vvvvv vvvvvvvvvvvv vvvvvvvvvv vvvvvvvvvvv vvvvvvvv
          </div>
          <div className="w-full sm:w-1/2 bg-blue-500 flex items-center justify-center text-white overflow-hidden whitespace-normal rounded-lg p-4 sm:p-5 md:p-6 lg:p-8">
            Bluevvv vvvvvvvvvvv vvvvvvvvvvvv  vvvvv vvvvvvvvvvvv vvvvvvvvv
            Bluevvv vvvvvvvvvvv vvvvvvvvvvvv  vvvvv vvvvvvvvvvvv vvvvvvvvvv vvvvvvvvvvv vvvvvvvv
          </div>
        </div>
      </div>
