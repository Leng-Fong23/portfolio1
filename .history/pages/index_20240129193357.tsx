...
<div className="grid place-items-center">
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
    ...
    <div className="flex-1 text-center sm:text-justify  lg:text-left -mt-2 sm:p-4 lg:p-4 lg:pl-8 lg:pr-8 pt-3 sm:pt-4 lg:pt-4 font-[georgia] text-1.5rem text-black justify-center items-center mx-auto">
...
<Menu as="div" className="relative inline-block text-left">
  ...
  <div className="py-1 text-white">
    <Menu.Item>
      ...
      <div className={`${styles.floatchild} lg:w-1/2`}>
        <div className="bg-[EEEDEB] rounded-lg px-1 md:px-12 -mt-10">
        <Timeline
      sx={{
        [`& .${timelineItemClasses.root}:before`]: {
          flex: 0,
